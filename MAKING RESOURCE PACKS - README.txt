...
• Meta data can also have an extra line on the end for the quality index for a texture asset (quality index is ignored for other asset types). It can be a number or the word "low", "mid" or "high" (case insensitive).
